    ...
    <footer id="footer">
        ...
        <ul>
            ...
            <li class="team-member">Anas - Frontend Developer and ICPC Team Member: Anas, a dedicated frontend developer
                and
                ICPC team member, showcases strong problem-solving abilities. His commitment is apparent as he advances
                in
            ...
            <li class="team-member">Mohamed - AI Engineer and Computer Science Student: Mohamed specializes in
                Artificial
                Intelligence and excels in Computer Science studies, reaching the third level in his educational
                journey.
            </li>
